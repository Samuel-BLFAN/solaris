...
if ( have_comments() || comments_open() ) {
	?>
	<section class="comments_wrap<?php echo (!have_comments() ? ' no_comments' : ''); ?>">
	<?php
	if ( have_comments() ) {
	?>
		<div id="comments" class="comments_list_wrap">
			<h2 class="section_title comments_list_title"><?php $post_comments = get_comments_number(); echo esc_attr($post_comments); ?> <?php echo esc_attr($post_comments==1 ? __('Comment', 'themerex') : __('Comments', 'themerex')); ?></h2>
	...
	?>
		<div class="comments_form_wrap">
			<h2 class="section_title comments_form_title"><?php _e('Leave a Comment', 'themerex'); ?></h2>
			<div class="comments_form">
				...
				$comments_args = array(
						...
						'label_submit'=>__('send message', 'themerex'),
