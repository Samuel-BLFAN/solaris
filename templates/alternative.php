...
if ( !function_exists( 'themerex_template_alternative_theme_setup' ) ) {
	...
	function themerex_template_alternative_theme_setup() {
		themerex_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => __('Alternative tile (with hovers, different sizes)', 'themerex'),
...
if ( !function_exists( 'themerex_template_alternative_output' ) ) {
	...
	?>">
		<<?php echo ($tag); ?> class="post_item post_item_<?php echo esc_attr($style); ?>
			...
			<div class="post_featured img">
				...
				<div class="hover_wrap">
					<div class="hover_content">
						...
						echo ($link_start_hover) . ($link_end); ?>
					</div>
				</div>
			</div>
		</div>				<!-- /.post_content -->
