			...
			$THEMEREX_GLOBALS['shortcodes'] = array(
				...
				"trx_block" => array(
					...
					"params" => array(
						...
						"stylization" => array(
							"title" => __("Stylize container", "themerex"),
							"desc" => __("Stylize container semi-circle (height of the field is equal to its width)", "themerex"),
							"value" => "no",
							"divider" => true,
							"type" => "switch",
							"options" => $THEMEREX_GLOBALS['sc_params']['yes_no']
				...
				"trx_columns" => array(
					...
					"params" => array(
						"autoheight" => array(
							"title" => __("Auto Height", "themerex"),
							"desc" => __("Fit height to the larger value of child elements (for background images)", "themerex"),
							"value" => "no",
							"type" => "switch",
							"options" => $THEMEREX_GLOBALS['sc_params']['yes_no']
						),
						"indentation" => array(
							"title" => __("Indentation", "themerex"),
							"desc" => __("Column is indented", "themerex"),
							"value" => "yes",
							"type" => "switch",
							"options" => $THEMEREX_GLOBALS['sc_params']['yes_no']
						),
				...
				"trx_contact_form" => array(
					...
					"params" => array(
						...
						"style" => array(
							...
							"desc" => __("Contact form style", "themerex"),
							"value" => "standard",
							"type" => "checklist",
							"options" => array(
								'standard' => __('Standard', 'themerex'),
								'destination' => __('Destination', 'themerex')
							)
						),
						"action" => array(
				...
				// Gallery
				"trx_gallery" => array(
					"title" => __("Gallery", "themerex"),
					"desc" => __("Insert gallery into your post (page)", "themerex"),
					"decorate" => true,
					"container" => false,
					"params" => array(
						"cat" => array(
						...
						"descriptions" => array(
							"title" => __("Post descriptions", "themerex"),
						...
						"bg_color" => array(
							"title" => __("Background color", "themerex"),
							"desc" => __("Select color for gallery background", "themerex"),
							"value" => "",
							"type" => "color"
						),
						"bg_image" => array(
							"title" => __("Background image", "themerex"),
							"desc" => __("Select or upload image or write URL from other site for the gallery background", "themerex"),
							"readonly" => false,
							"value" => "",
							"type" => "media"
						),
				...
				"trx_googlemap" => array(
					...
					"params" => array(
						...
						"description" => array(
							"title" => __("Description", "themerex"),
							"desc" => __("Description to show in map", "themerex"),
							"value" => "",
							"type" => "text"
						),
						"zoom" => array(
				...
				"trx_image" => array(
					...
					"params" => array(
						...
						"link" => array(
							"title" => __("Link URL", "themerex"),
							"desc" => __("Link URL for the title", "themerex"),
							"divider" => true,
							"value" => "",
							"type" => "text"
						),
				...
				"trx_quote" => array(
					...
					"params" => array(
						...
						"style" => array(
							"title" => __("Quote style", "themerex"),
							"desc" => __("Select style of Quote block", "themerex"),
							"value" => "1",
							"type" => "checklist",
							"dir" => "horizontal",
							"options" => array(
								'1' => __('Style 1 (with image)', 'themerex'),
								'2' => __('Style 2', 'themerex')
							)
						),
						"bg_image" => array(
							"title" => __("Background image", "themerex"),
							"desc" => __("Select or upload image or write URL from other site for the Quote background (Style 1)", "themerex"),
							"readonly" => false,
							"value" => "",
							"type" => "media"
						),
				...
				"trx_socials" => array(
					...
					"params" => array(
						...
						"style" => array(
							"title" => __("Socials style", "themerex"),
							"desc" => __("Socials style", "themerex"),
							"value" => "main",
							"type" => "select",
							"options" => array(
								'main' => __('Regular', 'themerex'),
					...
					"children" => array(
						...
						"params" => array(
							...
							"icon" => array(
								"title" => __('Icon',  'themerex'),
								"desc" => __("Select font icon from Fontello icons set (if style=iconed)",  'themerex'),
								"value" => "",
								"type" => "icons",
								"options" => $THEMEREX_GLOBALS['sc_params']['icons']
							)
				...
				"trx_testimonials" => array(
					...
					"params" => array(
						"style" => array(
							...
							"desc" => __("Select style to display testimonials members", "themerex"),
							"value" => "1",
							"type" => "select",
							"options" => array(
								1 => __('Style 1', 'themerex'),
					...
					"children" => array(
						...
						"params" => array(
							...
							"field" => array(
								"title" => __("Field", "themerex"),
								"desc" => __("Additional field (for Style 2)", "themerex"),
								"value" => "",
								"type" => "text"
							),
							"_content_" => array(
				...
				// Oblique section
				"trx_oblique" => array(
					"title" => __("Oblique section", "themerex"),
					"desc" => __("Container for holding one position (use it only on fullscreen pages)", "themerex"),
					"decorate" => true,
					"container" => false,
					"params" => array(
						"bg_image" => array(
							"title" => __("Background image", "themerex"),
							"desc" => __("Select or upload image or write URL from other site for oblique section background.", "themerex"),
							"readonly" => false,
							"value" => "",
							"type" => "media"
						),
						"position" => array(
							"title" => __("Position", "themerex"),
							"desc" => __("Position of the content block", "themerex"),
							"value" => "left",
							"type" => "checklist",
							"dir" => "horizontal",
							"options" => array(
						...
						"size" => array(
							...
							"desc" => __("Size of the oblique field", "themerex"),
							"value" => "normal",
							"type" => "checklist",
							"dir" => "horizontal",
							"options" => array(
								"normal" => __("Normal", 'themerex'),
								"big" => __("Big", 'themerex')
							)
						),
						"title_1" => array(
							"title" => __("Title", "themerex"),
							"desc" => __("Select Title", "themerex"),
							"value" => "",
							"type" => "text",
							"divider" => true
						),
						"title_2" => array(
							"title" => __("Title 2", "themerex"),
							"desc" => __("Select the second title", "themerex"),
							"value" => "",
							"type" => "text"
						),
						"description" => array(
							"title" => __("Description", "themerex"),
							"desc" => __("Description area", "themerex"),
							"value" => "",
							"type" => "text"
						),
						"info" => array(
							"title" => __("Info", "themerex"),
							"desc" => __("Info area", "themerex"),
							"value" => "",
							"type" => "text"
						),
						"text_link" => array(
						...
						"link" => array(
							"title" => __("Link URL", "themerex"),
							"desc" => __("URL for the link on button click", "themerex"),
							"value" => "",
							"type" => "text"
						),
						"top" => $THEMEREX_GLOBALS['sc_params']['top'],
