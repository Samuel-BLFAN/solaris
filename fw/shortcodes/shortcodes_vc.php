...
//			vc_remove_element("vc_accordion_tab");
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						"param_name" => "stylization",
						"heading" => __("Stylize container", "themerex"),
						"description" => __("Stylize container semi-circle (height of the field is equal to its width)", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => array(__('Stylize container', 'themerex') => 'yes'),
						"type" => "checkbox"
					),
					array(
						"param_name" => "color",
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"heading" => __("Auto Height", "themerex"),
						"description" => __("Fit height to the larger value of child elements (for background images)", "themerex"),
						"class" => "",
						"value" => array(__('Auto Height', 'themerex') => 'yes'),
						"type" => "checkbox",
					),
					array(
						"param_name" => "indentation",
						"heading" => __("Indentation", "themerex"),
						"description" => __("Column is indented", "themerex"),
						"class" => "",
						"value" => array(__('Indentation', 'themerex') => 'yes'),
						"type" => "checkbox",
					),
					themerex_vc_width(),
					themerex_vc_height(),
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"description" => __("Contact form style", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => array(
							__('Standard', 'themerex') => 'standard',
							__('Destination', 'themerex') => 'destination'
						),
						"type" => "dropdown"
					),
					themerex_vc_width(),
			...
			vc_map( array(
				...
				"description" => __("Insert gallery", "themerex"),
				"category" => __('Content', 'js_composer'),
				...
				"params" => array(
						...
						array(
							...
							"heading" => __("Post descriptions", "themerex"),
						...
						array(
							...
							"description" => __("Select color for Gallery background", "themerex"),
							"class" => "",
							"value" => "",
							"type" => "colorpicker",
							"admin_label" => true
						...
						array(
							...
							"description" => __("Select or upload image or write URL from other site for the Gallery background", "themerex"),
							"class" => "",
							"value" => "",
							"type" => "attach_image",
							"admin_label" => true
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						"description" => __("Description to show in map", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						"param_name" => "link",
						"heading" => __("Link URL", "themerex"),
						"description" => __("Link URL from title", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						"param_name" => "style",
						"heading" => __("Quote style", "themerex"),
						"description" => __("Select style of Quote block", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => array(
							__('Style 1 (with image)', 'themerex') => '1',
							__('Style 2', 'themerex') => '2'
						),
						"type" => "dropdown"
					),
					array(
						"param_name" => "bg_image",
						"heading" => __("Background image", "themerex"),
						"description" => __("Select or upload image or write URL from other site for the Quote background (Style 1)", "themerex"),
						"class" => "",
						"value" => "",
						"type" => "attach_image"
					),
			...
			vc_map( array(
				...
				"params" => array_merge(array(
					...
					array(
						"param_name" => "style",
						"heading" => __("Socials style", "themerex"),
						"description" => __("Socials style", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => array(
							__('Main', 'themerex') => 'main',
							__('Color', 'themerex') => 'color'
						),
						"type" => "dropdown"
					),
					$THEMEREX_GLOBALS['vc_params']['margin_top'],
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						"param_name" => "icon",
						"heading" => __("Icon", "themerex"),
						"description" => __("Select font icon from Fontello icons set (if style=iconed)", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => $THEMEREX_GLOBALS['sc_params']['icons'],
						"type" => "dropdown"
			...
			vc_map( array(
				...
				"params" => array(
					array(
						...
						"description" => __("Select style to display testimonials members", "themerex"),
						"class" => "",
						"admin_label" => true,
						"value" => array(
							__('Style 1', 'themerex') => 1,
					...
					array(
						"param_name" => "columns",
						"heading" => __("Columns", "themerex"),
						"description" => __("How many columns use to show team members (for Style 2)", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => "3",
						"type" => "textfield"
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						"param_name" => "field",
						"heading" => __("Field", "themerex"),
						"description" => __("Additional field (for Style 2)", "themerex"),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
			...
			vc_map( array(
				"base" => "trx_oblique",
				"name" => __("Oblique section", "themerex"),
				"description" => __("Container for holding one position (use it only on fullscreen pages)", "themerex"),
				"category" => __('Content', 'js_composer'),
				'icon' => 'icon_trx_block',
				"class" => "trx_sc_single trx_sc_oblique",
				"content_element" => true,
				"is_container" => false,
				"show_settings_on_create" => true,
				"params" => array(
					array(
						"param_name" => "bg_image",
						"heading" => __("Background image", "themerex"),
						"description" => __("Select or upload image or write URL from other site for oblique section background.", "themerex"),
						"class" => "",
						"value" => "",
						"type" => "attach_image",
						"admin_label" => true
					...
					array(
						"param_name" => "position",
						"heading" => __("Position", "themerex"),
						"description" => __("Position of the content block", "themerex"),
						"class" => "",
						"admin_label" => true,
						"value" => array(
							__('Left', 'themerex') => "left",
					...
					array(
						"param_name" => "size",
						"heading" => __("Size", "themerex"),
						"description" => __("Size of the oblique field", "themerex"),
						"class" => "",
						"value" => array(
							__('Normal', 'themerex') => "normal",
							__('Big', 'themerex') => "big"
						),
						"type" => "dropdown"
					),
					array(
						"param_name" => "title_1",
						"heading" => __("Title", "themerex"),
						"description" => __("Select Title", "themerex"),
						"admin_label" => true,
						"class" => "",
						"divider" => true,
						"value" => "",
					...
					array(
						"param_name" => "title_2",
						"heading" => __("Title 2", "themerex"),
						"description" => __("Select the second title", "themerex"),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						"param_name" => "description",
						"heading" => __("Description", "themerex"),
						"description" => __("Description area", "themerex"),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						"param_name" => "info",
						"heading" => __("Info", "themerex"),
						"description" => __("Info area", "themerex"),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
			...
			class WPBakeryShortCode_Trx_Oblique extends THEMEREX_VC_ShortCodeSingle {}
