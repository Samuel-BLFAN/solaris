...
if ( !function_exists( 'themerex_get_list_button_styles' ) ) {
	function themerex_get_list_button_styles($prepend_inherit=false) {
		...
		if (isset($THEMEREX_GLOBALS['list_button_styles']))
			...
			$list["link"] 	= __('Link', 'themerex');
			$list["user"] 	= __('User', 'themerex');
			$list["color"] 	= __('Color', 'themerex');
			$list["color_2"] 	= __('Color 2', 'themerex');
			$list["white"] 	= __('White(hover 1)', 'themerex');
			$list["white_2"] 	= __('White(hover 2)', 'themerex');
