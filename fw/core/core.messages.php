	...
	function themerex_messages_add_scripts_inline() {
		...
		echo '<script type="text/javascript">'
			...
			. 'THEMEREX_GLOBALS["strings"] = {'
				...
				. 'criteria_empty:		"' . addslashes(__('The predefined destinations can\'t be empty', 'themerex')) . '",'
				. 'criteria_long:		"' . addslashes(__('Too long predefined destinations', 'themerex')) . '",'
				. 'date_start_empty:		"' . addslashes(__('The date start can\'t be empty', 'themerex')) . '",'
				. 'date_end_empty:		"' . addslashes(__('The date end can\'t be empty', 'themerex')) . '",'
				...
				. 'send_order_complete:	"' . addslashes(__("Your request has been received. We will get back to you asap!", 'themerex')) . '",'
				...
				. 'password_empty:		"' . addslashes(__('The password can\'t be empty and shorter then 5 characters', 'themerex')) . '",'
