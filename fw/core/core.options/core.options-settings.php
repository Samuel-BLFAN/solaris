...
if ( !function_exists( 'themerex_options_settings_theme_setup' ) ) {
	...
	function themerex_options_settings_theme_setup() {
		...
		"main_color" => array(
					"title" => __('Main color', 'themerex'),
					"desc" => __('Select main theme color', 'themerex'),
					"override" => "category,post,page",
					"std" => "",
					"type" => "color"),

		"accent_color" => array(
					"title" => __('Accent color', 'themerex'),
					"desc" => __('Select accent theme color', 'themerex'),
					"divider" => false,
					"override" => "category,post,page",
					"std" => "",
					"type" => "color"),
		...
		"show_page_title_desc" => array(
					"title" => __('Show Page title description', 'themerex'),
					"desc" => __('Show post/page/category title description', 'themerex'),
					"override" => "category,post,page",
					"std" => "no",
					"options" => $THEMEREX_GLOBALS['options_params']['list_yes_no'],
					"type" => "switch"),
		...
		"page_title_desc" => array(
					"title" => __('Page title description', 'themerex'),
					"desc" => __('Description for a title', 'themerex'),
					"divider" => false,
					"override" => "category,post,page",
					"std" => "",
					"before" => array('icon'=>'iconadmin-align-center'),
					"type" => "text"),
		...
		"googlemap_description" => array(
					...
					"desc" => __("Enter Description to show on map", 'themerex'),
					"override" => "category,page,post",
					"std" => "",
					"type" => "text"),
		...
		"single_style" => array(
			...
			"portfolio_image_style" => array(
				"title" => __('Style display images in a portfolio (alternative)', 'themerex'),
				"desc" => __('Select style of the images in the portfolio (only for Blog style = Alternative)', 'themerex'),
				"divider" => true,
		...
		"show_post_tags" => array(
					"title" => __('Show post tags and categories',  'themerex'),
					"desc" => __("Show tags block and categories on single post page", 'themerex'),
					"override" => "category,post,page",
					"std" => "yes",
					"options" => $THEMEREX_GLOBALS['options_params']['list_yes_no'],
					"type" => "switch"),
		...
		"show_post_counters" => array(
					"title" => __('Show post counters',  'themerex'),
		...
		"contacts_criterias_list" => array(
					"title" => __('Criterion lists', 'themerex'),
					"desc" => __('Criterion lists (Shortcode -> "Contact Form, style -> order"). Words to mark criterials levels. Just write the word and press "Enter". Also you can arrange words.', 'themerex'),
					"std" => __("Australia,London,New York,Copenhagen,Germany,Amsterdam,Paris,Los Angeles,Barcelona,Stockholm", 'themerex'),
					"type" => "tags"),
		...
		"show_search" => array(
					...
					"desc" => __('Show search field in the top area(user menu)', 'themerex'),
					"divider" => false,
					"std" => "yes",
					"options" => $THEMEREX_GLOBALS['options_params']['list_yes_no'],
					"type" => "switch"),
