	...
	<div class="body_wrap">
		...
		<div class="page_wrap">
			...
			if (themerex_get_custom_option('show_page_top') == 'yes') {
				...
				$title_desc = themerex_get_custom_option('page_title_desc');
				?>
				<div class="page_top_wrap<?php echo ($show_title ? ' page_top_title' : '') . ($show_breadcrumbs ? ' page_top_breadcrumbs' : ''); ?>">
					...
					<?php if ($show_title) { ?>
						<div class="page_title_wrap content_wrap">
							...
							<?php if ($title_desc && !empty($title_desc) && $show_title_desc) { ?>
								<span class="page_title_desc"><?php echo esc_html($title_desc); ?></span>
							<?php } ?>
						</div>
					<?php } ?>
				</div>
